...
export default function PreviewPage({ is, post, ClubInfo }) {
  const {
    club,
    date,
    description,
        ...
        <div className={styles.right_div}>
          ...
          <div>
            ...
            <ol className={styles.request_process}>
              <li>
                Request is sent to the president or coordinator of the
                respective club.
              </li>
              <li>
                The request is either be discarded or accepted by the
                coordinator or president.
              </li>
              <li>
                If the request is accepted it will be uploaded to upcoming
                section otherwise it will be discarded.
              </li>
            </ol>
          </div>
        </div>
